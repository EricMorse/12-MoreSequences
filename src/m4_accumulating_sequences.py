...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        ...
        left_rect = rg.Point(circles[k].center.x - radius, circles[k].center.y - radius)
        right_rect = rg.Point(circles[k].center.x + radius, circles[k].center.y + radius)
        rect = rect + [rg.Rectangle(left_rect, right_rect)]
